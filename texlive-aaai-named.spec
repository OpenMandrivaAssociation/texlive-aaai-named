...
Source1:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/aaai-named.doc.r%{version}.tar.xz
Source2:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/aaai-named.source.r%{version}.tar.xz
BuildArch:	noarch
